...
public class Ventana extends JFrame {
    ...
    public Ventana(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(105, 175, 95));
        lblId = new JLabel("Id:");
        ...
        panel2.setBackground(new Color(91, 33, 126, 215));
        info = new ArrayList<>();
        info.add(new Videojuego(1, "League of Legends", "MOBA",4.5, "Windows y Mac", "Riots games"));
