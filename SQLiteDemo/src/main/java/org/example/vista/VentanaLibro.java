...
public class VentanaLibro  extends JFrame {
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(143, 197, 97, 255));
        lblId = new JLabel("Id: ");
        ...
        panel2.setBackground(new Color(97, 144, 197, 255));
        ...
        panel3.setBackground(new Color(197, 97, 97, 255));

        //Panel 4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(152, 97, 197, 255));
